...
kyty_mount('/home/brice/Projects/kyty-assets/openorbis/OpenOrbis/PS4Toolchain/samples/exceptions', '/app0');

kyty_load_elf('/app0/exceptions/x64/Debug/exceptions.oelf');
