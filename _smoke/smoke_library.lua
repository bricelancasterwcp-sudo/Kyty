...
kyty_mount('/home/brice/Projects/kyty-assets/openorbis/OpenOrbis/PS4Toolchain/samples/using_library', '/app0');

kyty_load_elf('/app0/using_library/x64/Debug/using_library.oelf');
