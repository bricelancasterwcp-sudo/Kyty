...
kyty_mount('/tmp/claude-1000/-home-brice/e3bdfbc6-ed39-4f6e-ad6a-b2588420bb1a/scratchpad/openorbis/OpenOrbis/PS4Toolchain/samples/graphics', '/app0');

kyty_load_elf('/app0/graphics/x64/Debug/graphics.oelf');
