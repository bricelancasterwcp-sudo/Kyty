...
kyty_mount('/tmp/claude-1000/-home-brice/e3bdfbc6-ed39-4f6e-ad6a-b2588420bb1a/scratchpad/openorbis/OpenOrbis/PS4Toolchain/samples/SDL2', '/app0');

kyty_load_elf('/app0/SDL2/x64/Debug/SDL2.oelf');
