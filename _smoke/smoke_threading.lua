...
kyty_mount('/home/brice/Projects/kyty-assets/openorbis/OpenOrbis/PS4Toolchain/samples/threading', '/app0');

kyty_load_elf('/app0/threading/x64/Debug/threading.oelf');
