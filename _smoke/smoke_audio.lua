...
kyty_mount('/home/brice/Projects/kyty-assets/openorbis/OpenOrbis/PS4Toolchain/samples/audio-wav', '/app0');

kyty_load_elf('/app0/audio-wav/x64/Debug/audio-wav.oelf');
